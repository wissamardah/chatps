...
app.post("/uploadr2", async (req, res) => {
    try {
      ...
      const fileExtension = 'jpg'; // or extract the file extension from the file (if known)
      const uniqueFileName = `${timestamp}-${randomString}.${fileExtension}`;
  
      // Set parameters for R2 upload
      const params = {
        Bucket: 'chat',  // Your Cloudflare R2 bucket name
        Key: uniqueFileName,  // Unique file name
        Body: fileBuffer,  // File buffer from request
